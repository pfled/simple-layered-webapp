...
namespace Factorial.UnitTests.Services
{
    public class FactorialService_CalcFact
    {
        ...
        public void TestCalculateFactorial_Input0()
        {
            ...
            Assert.Equal(expectedResult.ToString("N0"), FactorialService.CalculateFactorial(0));
        }
        ...
        {
            BigInteger expectedResult = 1;
            Assert.Equal(expectedResult.ToString("N0"), FactorialService.CalculateFactorial(1));
        }
        ...
        public void TestCalculateFactorial_Input3()
        {
            ...
            Assert.Equal(expectedResult.ToString("N0"), FactorialService.CalculateFactorial(3));
        }
        ...
        public void TestCalculateFactorial_Input10()
        {
            ...
            Assert.Equal(expectedResult.ToString("N0"), FactorialService.CalculateFactorial(10));
        }
        ...
        public void TestCalculateFactorial_Input100()
        {
            ...
            Assert.Equal(expectedResult.ToString("N0"), FactorialService.CalculateFactorial(100));
        }
    }
}